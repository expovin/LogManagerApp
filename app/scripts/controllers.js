...
.filter('custom', function() {
  return function(input, search) {
    ...
    return result;
        ...
        .controller('LogsViewController', ['$scope','$window','$localStorage','$sessionStorage','$modal','$location', 'logsViewFactory','$state',
            function($scope,$window,$localStorage,$sessionStorage,$modal,$location,logsViewFactory,$state) {
            ...
            //var currentNav = $sessionStorage.getCurrentNav($scope.server);
        ...
        .controller ('ModalShowFieldsController',['$scope','$modal','$modalInstance','$sessionStorage','$window','$location', function($scope,$modal,$modalInstance,$sessionStorage,$window,$location) {
            ...
            for(var rec in $scope.record){
                var alert;

                if($scope.record[rec].Level == undefined)
                    alert=$scope.record[rec].﻿Severity;
                else
                    alert=$scope.record[rec].Level;
                console.log(alert);


                switch(alert) {
                    case 'INFO' : $scope.alert.push('info'); break;
                    case 'WARN' : $scope.alert.push('warning'); break;
                    case "ERROR" : $scope.alert.push('danger'); break;
                    default :  $scope.alert.push('success');
                }
            }
